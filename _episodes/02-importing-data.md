...
> 
> When working with a dataset, it is critical to evaluate whether its attributes meets quality standards required for the project/task. This includes checking for missing data and inspect for erros in data input, verifying if the data is in the desired unit of analysis, and if the sample size is enough to support their intended use. We typically suggest you inspect the data having five criteria in mind:
